...
export default function AreasScreen() {
  ...
  const availableAreas = useMemo(() => {
    ...
    return AREAS_OF_CONCERN.filter(area => availableAreaIds.includes(area.id));
  }, [state.selectedConcerns, caseData, state.ageRange, state.skinType, state.skinTone, state.ethnicBackground]);
