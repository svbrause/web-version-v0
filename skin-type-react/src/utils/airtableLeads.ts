...
export async function submitLeadToAirtable(
  ...
  try {
    ...
    if (contentType.includes('text/html')) {
      ...
      throw new Error(`API route returned HTML instead of JSON. In development, set VITE_AIRTABLE_API_KEY and VITE_AIRTABLE_BASE_ID in .env file to use direct Airtable API.`);
    }
    ...
    if (record) {
      ...
      console.log('📊 Record created with fields:', record.fields || 'No fields in response');
